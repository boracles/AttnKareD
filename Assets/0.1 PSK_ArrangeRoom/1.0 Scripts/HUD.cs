...
public class HUD : MonoBehaviour
{
    ...
    *************************************************/
    ...
    /************************************************
    //물건 정리할 위치 녹색 Target 표시합니다
    *************************************************/  
    //Manager.ARRANGE m_eGrabbed = Manager.ARRANGE.NONE;
    //public void ShowTarget(Manager.ARRANGE eGrabbed) {
    //   m_eGrabbed = eGrabbed;
    //   for(int i=0; i< Manager.CDB.Length; i++) { 
    //       Manager.CDB[i].target.SetActive(Manager.CDB[i].eArrange == m_eGrabbed);
    //   }      
    //}    
