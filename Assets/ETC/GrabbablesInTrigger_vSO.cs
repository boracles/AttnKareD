...
namespace BNG
{
    ...
    /// </summary>
    public class GrabbablesInTrigger_vSO : MonoBehaviour
    {
        ...
        private GameObject getCRG_obj;
        private string getCRG_name;        
        ...
        void Update()
        {
            ...
            getCRG_name = ClosestRemoteGrabbable.ToString();

            if(ClosestRemoteGrabbable != null)
            {
